...
public class Graph {
	...
	public void readFromFiles(String fileCrowd, String fileNodes, String fileTime) throws FileNotFoundException {
		try {
			BufferedReader inCrowd = new BufferedReader(new FileReader(fileCrowd));
			BufferedReader inSust = new BufferedReader(new FileReader(fileNodes));
			BufferedReader inTime = new BufferedReader(new FileReader(fileTime));

			String line = inCrowd.readLine();
