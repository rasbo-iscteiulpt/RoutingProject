...
public class Node {
    ...
    protected HashMap<String,NodeData> neighbors2;
    protected Double visitTime;
    ...
    public HashMap<String, NodeData> getNeighbors2() {
    	return neighbors2;
    }
    
    public void setNeighbors2(HashMap<String, NodeData> neighbors2) {
