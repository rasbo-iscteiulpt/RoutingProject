...
public class Eppstein implements KSPAlgorithm {
     ...
     */
    public List<PathUtil> ksp(Graph graph, String sourceLabel, String targetLabel, int K) {
        ...
        ArrayList<PathUtil> ksp = new ArrayList<PathUtil>();
        ...
        for (int i = 0; i < K && pathPQ.size() > 0; i++) {
            ...
            PathUtil kpath = kpathImplicit.explicitPath(ksp, tree);
     ...
     */
    protected static void addExplicitChildrenToQueue(EppsteinPath kpathImplicit, ArrayList<PathUtil> ksp, PriorityQueue<EppsteinPath> pathPQ) {
     ...
     * @param pathPQ            priority queue of candidate paths
     */
    protected static void addCrossEdgeChildToQueue(HashMap<String,EppsteinHeap> outrootHeaps, EppsteinPath kpathImplicit, int prefPath, ArrayList<PathUtil> ksp, PriorityQueue<EppsteinPath> pathPQ) {
...
class EppsteinPath implements Comparable<EppsteinPath> {
    ...
    public PathUtil explicitPath(List<PathUtil> ksp, ShortestPathTree tree) {
        PathUtil explicitPath = new PathUtil();
        ...
        if (prefPath >= 0) {
            ...
            PathUtil explicitPrefPath = ksp.get(prefPath);
