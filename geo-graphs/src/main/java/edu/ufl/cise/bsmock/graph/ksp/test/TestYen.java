...
public class TestYen {
	...
	private String graphFilename, sourceNode, targetNode;
    private int K;
	
    public TestYen(String graphFilename, String sourceNode,String targetNode, int K) {
    ...
    public static void main(String args[]) {
        ...
        /* Example 1 */
        graphFilename = "C:\\Users\\Ana Rita\\Desktop\\wsTESE\\geo-graphs\\src\\main\\java\\edu\\ufl\\cise\\bsmock\\graph\\ksp\\test\\test_b.txt";
        sourceNode = "1";
        targetNode = "5";
        K = 100;
